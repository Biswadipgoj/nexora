...
/**
 * Signup page.
 * §3.7: Email/password signup with email verification.
 * §7.8: Time-to-first-work-item — zero required reading.
 * §30.2: All five states defined.
 */
export default function SignupPage() {
        ...
        <div className="auth-success">
          <div className="auth-success__icon">
            <svg width="48" height="48" viewBox="0 0 48 48" fill="none" aria-hidden="true">
              ...
              <path d="M16 24l6 6 10-12" stroke="var(--color-success)" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </div>
          ...
          <Link href="/auth/login" className="auth-form__link" style={{ display: 'block', textAlign: 'center' }}>
            Back to sign in
          </Link>
        </div>
        <style>{`
  ...
  return (
    <div className="auth-form">
      ...
      <p className="auth-form__subtitle">Get started for free — no credit card required</p>
