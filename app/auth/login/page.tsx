...
/**
 * Login page.
 * §3.7: Email/password login + OAuth (Google, GitHub).
 * §30.2: All five states — empty, loading, error, success, degraded.
...
export default function LoginPage() {
  ...
  return (
    <div className="auth-form">
      ...
      <p className="auth-form__subtitle">Sign in to your workspace</p>
      ...
      {/* Email/password form */}
      <form onSubmit={handleEmailLogin} className="auth-form__fields">
        ...
        <div className="auth-form__field">
          <div className="auth-form__label-row">
            ...
            <Link href="/auth/forgot-password" className="auth-form__link">
              Forgot password?
            </Link>
          </div>
          <input
      ...
      <p className="auth-form__footer">
        ...
        <Link href="/auth/signup" className="auth-form__link">
          Create one
        </Link>
      </p>
